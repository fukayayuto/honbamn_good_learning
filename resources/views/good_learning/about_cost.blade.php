...
<div id="wrapper"> 
  <main>
    <div id="mainImg">
		<div id="mainTxt"> 
		<h1><img src="{{ asset('img/main_tit.svg') }}" alt="いつでもどこでも受講可能 グッドラーニングの初任運転者研修" width="465" height="203"></h1>
		  <p>グッドラーニングの初任運転者講習はパソコン・スマートフォン・タブレットに対応しており、いつでもどこでもお好きな時間に受講することが出来ます。</p>
			<div id="corpLogo">
				<ul>
				<li><img src="{{ asset('img/logo_kyoto.png') }}" width="294" height="56" alt="一般社団法人 京都府トラック協会"/><span>12項目も導入</span></li>
				<li><img src="{{ asset('img/logo_mie.png') }}" width="264" height="44" alt="一般社団法人 三重県トラック協会"/><span>全国で初採用</span></li>
				</ul>
			</div>
		</div> 
	  <div id="mainPh"><img src="{{ asset('img/mainimg.webp') }}" alt="トラック運転者" width="682" height="768"></div>
    </div>
	  
	 <div id="about"> 
	  <h2><img src="{{ asset('img/tit01.svg"') }}" width="556" height="93" alt="グッドラーニング！の初任運転者研修はオンライン型学習システム"></h2>
		 <ul>
		 <li> 
		   <div class="ph"><img src="{{ asset('img/illust01.webp"') }}" alt="オンライン学習" width="230" height="230"></div>
			 <h3>座学講座をeラーニングで受講</h3>
			 <p>国土交通省が定めている「初任運転者に対する特別な指導」の法定義務は15時間。そのうち12時間分の座学講座をeラーニングで受講できます。
			 </p></li>
		 <li> 
		   <div class="ph"><img src="{{ asset('img/illust02.webp"') }}" alt="オンライン学習" width="230" height="230"></div>
	  ...
	  <div id="info"> 
	  <h2><span><img src="{{ asset('img/tit02.svg"') }}" alt="初任運転者研修" width="302" height="30"></span></h2>
...
【振込口座】三井住友銀行　渋谷支店　普通9492637　株式会社キャブステーション</td></tr></table></div>
	  ...
	  <div id="application"> 
	  <h2 class="mt40 mb20"><span><img src="{{ asset('img/tit07.svg"') }}" alt="お申込み" height="30"></span></h2>
	  <div class="priceBox">
	  <h3>受講料金</h3>
			  <ul class="price">
			  <li><h5>非会員</h5>
...
日曜・祝日</span>
	  ...
	  <div id="flow"> 
	  <h2><span><img src="{{ asset('img/tit03.svg"') }}" width="439" height="35" alt="グッドラーニング！受講の流れ"></span></h2>
		  <ol>
...
<span class="cap">※国土交通省の定めにより当該教材を3年間、お手元で保管してください。</span></li></ol>
	  ...
	  <div id="reason">
	  <h2><span><img src="{{ asset('img/tit04.svg"') }}" width="439" height="35" alt="グッドラーニング！が選ばれる理由"></span></h2>
	  <div class="reasonBox">
		  <div class="driver"> 
		  <h3><img src="{{ asset('img/subtit01.svg"') }}" alt="ドライバーのメリット"></h3>
			  <div class="box">
...
7日間の受講期間内であれば都合の良い時間にパソコンや、スマホ、タブレットから受講することができます。</p>
		  ...
		  <div class="manager"> 
		  <h3><img src="{{ asset('img/subtit02.svg"') }}" alt="事業者・管理者のメリット"></h3>
			  <div class="box">  
			  <div class="ph"><img src="{{ asset('img/ph02.webp"') }}" alt="修了証" width="310" height="175"></div>
				  <h4>指導記録簿・修了証付き</h4>
				  <p>国土交通省の定めにより当該教材と指導記録簿を3年間、保管する必要があります。</p>
			  </div>
			  <div class="box">  
			  <div class="ph"><img src="{{ asset('img/ph03.webp"') }}" alt="ドライブレコーダー" width="310" height="175"></div>
				  <h4>充実した教育内容</h4>
...
日曜・祝日</span>
	  ...
	  <div id="achieve"> 
	  <h2><span><img src="{{ asset('img/tit05.svg"') }}" width="439" height="35" alt="グッドラーニング！ご採用実績"></span></h2>
		  <div class="inner">
...
北は北海道から南は九州・沖縄まで多くの企業様・ドライバー様にお使いいただき、安心・安全の一助となっております。</p>
	  ...
	  <div id="faq"> 
	  <h2><span><img src="{{ asset('img/tit06.svg"') }}" width="439" height="35" alt="FAQ"></span></h2>
	  <dl>
