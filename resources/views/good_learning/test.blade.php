...
<html lang="ja">
  <head>
    ...
    <meta
      name="title"
      content="乗務員教育のクラウド型eラーニング【グッドラーニング!】"
    />
    <meta
      name="description"
    ...
    <meta
      name="keywords"
      content="乗務員,教育,研修,Eラーニング,指導,国交省,バス,運送業,グッドラーニング"
    />
    <meta
      property="og:title"
      content="乗務員教育のクラウド型eラーニング【グッドラーニング!】"
    ...
    <meta property="og:url" content="https://promote.good-learning.jp/" />
    <meta
      property="og:image" 
      content="{{ asset('img/shared/og_image.jpg') }}"
    />
    <meta
    ...
    <meta
      ...
      content="グッドラーニング！は、国交省の「一般的な指導および監督の指針」に対応した、運転者の指導教育に特化したeラーニングシステムです。時間と場所を選ばずに、すべての乗務員に対して効率よく指導教育を実施することができます。"
    />
    <link rel="canonical" href="https://promote.good-learning.jp/" />
        ...
        <div id="mainImg">
          <div class="txtBox">
            <ul>
              <li>
                <img 
                  src="{{ asset('img/index/main_point01.webp') }}"
                  alt="指導教育記録簿自動作成"
                  width="205"
                  height="205"
                  loading="lazy"
              ...
              <li>
                <img
                  src="{{ asset('img/index/main_point02.webp') }}"
                  alt="国交省指定安全教育対応"
                  width="205"
                  height="205"
                  loading="lazy"
              ...
              <li>
                <img
                  src="{{ asset('img/index/main_point03.webp') }}"
                  alt="どこでも受講！PC・スマホ対応"
                  width="205"
                  height="205"
                  loading="lazy"
              ...
              <li>
                <img
                  src="{{ asset('img/index/main_point04.webp') }}"
                  alt="リーズナブルな料金体系"
                  width="205"
                  height="205"
                  loading="lazy"
            ...
            <div>
              <img 
                src="{{ asset('img/index/main_tit_smt.webp') }}"
                alt="バス・タクシー乗務員教育のクラウド型eラーニング グッドラーニング!"
                width="717"
                height="361"
                class="smt"
                loading="lazy"
              /><img 
                src="{{ asset('img/index/main_tit.webp') }}"
                alt="バス・タクシー乗務員教育のクラウド型eラーニング グッドラーニング!"
                width="786"
                height="239"
                class="pc"
      ...
      <main>
          ...
          <div id="newsIn">
            ...
            <ul>
               <li>
                ...
                >二葉計器様と合同オンラインセミナー開催いたしました。
              </li>
               <li>
                <span>2021.10.29</span
                ><a href="/adopt/">神田観光株式会社様</a
                >にご採用頂きました。
              </li>
               <li>
                <span>2021.09.07</span
                ><a href="/adopt/">南阿蘇交通株式会社様</a
                >にご採用頂きました。
              </li>
               <li>
                <span>2021.08.06</span
                ><a href="/adopt/">西表島交通株式会社様</a
                >にご採用頂きました。
              </li>
              <li>
                <span>2021.05.18</span
                ><a href="/adopt/">株式会社えびす交通様</a
                >にご採用頂きました。
              </li>
               <li>
                <span>2021.04.20</span
                ><a href="/adopt/">スマイニー観光株式会社様</a
                >にご採用頂きました。
              </li>
              </ul>
          </div>
        ...
        <div id="topContent02">
          <div id="topContentInfo">
            <h2>
              <img 
                src="{{ asset('img/shared/ico_logo.svg') }}"
                alt="グッドラーニング"
                width="390"
                height="54"
                loading="lazy"
...
時間と場所を選ばずに、すべてのドライバー・乗務員に対して効率よく指導教育を実施することができます。
          ...
          <div class="pointBox">
            <img
              src="{{ asset('img/index/point_ph01.jpg') }}"
              alt="いつでも受講可能"
              width="750"
              height="500"
              loading="lazy"
          ...
          <div class="pointBox">
            <img
              src="{{ asset('img/index/point_ph02.jpg') }}"
          ...
          <div class="pointBox">
            <img
              src="{{ asset('img/index/point_ph03.jpg') }}"
...
※国土交通省告示「旅客・貨物自動車運送事業者が事業用自動車の運転者に対して行う指導及び監督の指針」（２０１８年６月改正）
          ...
          <div class="pointBox">
            <img  
              src="{{ asset('img/index/point_ph04.jpg') }}"
              ...
              <ul>
                ...
                <li>
                  <a
                    ...
                    target="_blank"
                    class="icoPlay"
                    >特別講座「過労運転防止のため、改善基準告示を正しく理解しよう」サンプル動画</a
                  >
                </li>
              </ul>
            </div>
          ...
          <div class="pointBox">
            <img
              src=" {{ asset('img/index/point_ph05.jpg') }}"
...
※１件あたり２０ＭＢ以内、合計で１ＧＢ以内
          ...
          <div class="pointBox">
            <img
              src="{{ asset('img/index/point_ph06.jpg') }}"
...
-->
      ...
      <footer>
        <div class="inner">
          <div class="footLogo">
            <img
              src="{{ asset('img/shared/foot_logo.svg') }}"
              alt="グッドラーニング"
              width=""
              height=""
              loading="lazy"
    ...
    <!-- js -->
    <script src="{{ asset('css/common.css') }}"></script>
