...
<html lang="ja">
  <head>
    ...
    <meta
      property="og:image" 
      content="http://localhost:8888//truck/img/shared/og_image.jpg"
    /> 
    <meta
    ...
    <link href="{{ asset('/truck/css/top.css') }}" rel="stylesheet" type="text/css" />
        ...
        <div id="mainImg">
          <div class="txtBox">
            <ul>
              <li>
                <img  
                  src="{{ asset('/truck/img/index/main_point01.png') }}"
                  alt="指導教育記録簿自動作成"
                  width="205"
                  height="205"
                  loading="lazy"
              ...
              <li>
                <img 
                  src="{{ asset('/truck/img/index/main_point02.png') }}"
                  alt="国交省指定安全教育対応"
                  width="205"
                  height="205"
                  loading="lazy"
              ...
              <li>
                <img 
                  src="{{ asset('/truck/img/index/main_point03.png') }}"
                  alt="どこでも受講！PC・スマホ対応"
                  width="205"
                  height="205"
                  loading="lazy"
              ...
              <li>
                <img 
                  src="{{ asset('/truck/img/index/main_point04.png') }}"
                  alt="リーズナブルな料金体系"
                  width="205"
                  height="205"
                  loading="lazy"
            ...
            <div>
              <img 
                src="{{ asset('/truck/img/index/main_tit_smt.png') }}"
                ...
                loading="lazy"
              /><img 
                src="{{ asset('/truck/img/index/main_tit.png') }}"
                alt="トラックドライバー教育のクラウド型eラーニング グッドラーニング!"
                width="786"
                height="239"
                class="pc"
      ...
      <main>
        ...
        <div id="topContent02">
          <div id="topContentInfo">
            <h2>
              <img 
                src="{{ asset('/truck/img/shared/ico_logo.svg') }}"
                alt="グッドラーニング"
                width="390"
                height="54"
                loading="lazy"
...
ドラーニング！PRアニメーション"
          ...
          <div class="pointBox">
            <img 
              src="{{ asset('/truck/img/index/point_ph01.jpg') }}"
              alt="いつでも受講可能"
              width="750"
              height="500"
              loading="lazy"
          ...
          <div class="pointBox">
            <img 
              src="{{ asset('/truck/img/index/point_ph02.jpg') }}"
          ...
          <div class="pointBox">
            <img
              src="{{ asset('/truck/img/index/point_ph03.jpg') }}"
          ...
          <div class="pointBox">
            <img
              src="{{ asset('/truck/img/index/point_ph04.jpg') }}"
          ...
          <div class="pointBox">
            <img
              src="{{ asset('/truck/img/index/point_ph05.jpg') }}"
          ...
          <div class="pointBox">
            <img
              src="{{ asset('/truck/img/index/point_ph06.jpg') }}"
        ...
        <div id="topMedia">
          <div id="topMediaIn">
            ...
            <ul>
              <li>
                <img
                  src="{{ asset('/truck/img/index/media_ph01.jpg') }}"
              ...
              <li>
                <img  
                  src="{{ asset('/truck/img/index/media_ph02.jpg') }}"
